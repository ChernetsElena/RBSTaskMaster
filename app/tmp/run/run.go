...
import (
	...
	_ "taskmaster/app"
	controllers1 "taskmaster/app/controllers"
	tests "taskmaster/tests"
...
func Register() {
	...
	revel.RegisterController((*controllers1.CStatus)(nil),
		[]*revel.MethodType{
			&revel.MethodType{
				Name: "Init",
				Args: []*revel.MethodArg{ 
	...
	revel.RegisterController((*controllers1.CUrgently)(nil),
		[]*revel.MethodType{
			&revel.MethodType{
				Name: "Init",
				Args: []*revel.MethodArg{ 
